...
getRouter()->setDefaultRoute('render'); // akcja/ścieżka domyślna
getRouter()->setLoginRoute('login'); // akcja/ścieżka na potrzeby logowania (przekierowanie, gdy nie ma dostępu)

getRouter()->addRoute('render',    'CalcController',  ['user','admin']);
getRouter()->addRoute('compute', 'CalcController',  ['user','admin']);
